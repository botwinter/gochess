...
func Test_generatePawnMoves(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			[]move{
				move{4, 1, 4, 2, empty, quiet, none},
				move{4, 1, 4, 3, empty, quiet, none},
			},
		},
		{
			"test take",
			...
			[]move{
				move{4, 6, 4, 5, empty, quiet, none},
				move{4, 6, 4, 4, empty, quiet, none},
				move{4, 6, 3, 5, empty, quiet, none},
			},
		},
		{
...
func Test_generateRookMoves(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			[]move{
				move{3, 3, 2, 3, empty, quiet, none},
				move{3, 3, 1, 3, empty, quiet, none},
				move{3, 3, 4, 3, empty, quiet, none},
				move{3, 3, 3, 2, empty, quiet, none},
				move{3, 3, 3, 4, empty, quiet, none},
			},
		},
		{
			"test basic 2",
			...
			[]move{
				...
				move{3, 3, 1, 3, empty, quiet, none},
				move{3, 3, 4, 3, empty, quiet, none},
				move{3, 3, 5, 3, empty, quiet, none},
				move{3, 3, 6, 3, empty, quiet, none},
				move{3, 3, 7, 3, empty, quiet, none},
				move{3, 3, 3, 2, empty, quiet, none},
				move{3, 3, 3, 4, empty, quiet, none},
			},
		},
		{
			...
			[]move{
				move{5, 1, 4, 1, empty, quiet, none},
				move{5, 1, 6, 1, empty, quiet, none},
				move{5, 1, 7, 1, empty, quiet, none},
			},
		},
	}
	for _, tt := range tests {
...
func Test_generateKnightMoves(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			[]move{
				move{4, 1, 2, 0, empty, quiet, none},
				move{4, 1, 2, 2, empty, quiet, none},
				move{4, 1, 3, 3, empty, quiet, none},
				move{4, 1, 6, 2, empty, quiet, none},
				move{4, 1, 6, 0, empty, quiet, none},
			},
		},
		{
			"test bounds",
			...
			[]move{
				move{0, 0, 1, 2, empty, quiet, none},
				move{0, 0, 2, 1, empty, quiet, none},
			},
		},
		{
			"test rook on row",
...
func Test_generateBishopMoves(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			[]move{
				move{3, 4, 2, 3, empty, quiet, none},
				move{3, 4, 1, 2, empty, quiet, none},
				move{3, 4, 2, 5, empty, quiet, none},
				move{3, 4, 1, 6, empty, quiet, none},
				move{3, 4, 0, 7, empty, quiet, none},
				move{3, 4, 4, 5, empty, quiet, none},
			},
		},
		{
			"test rook on col",
		...
		},
		{
			...
			[]move{
				move{6, 5, 5, 4, empty, quiet, none},
				move{6, 5, 7, 6, empty, quiet, none},
			},
		},
	}
	for _, tt := range tests {
...
func Test_generateQueenMoves(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			[]move{
				move{2, 3, 1, 3, empty, quiet, none},
				move{2, 3, 0, 3, empty, quiet, none},
				move{2, 3, 3, 3, empty, quiet, none},
				move{2, 3, 2, 2, empty, quiet, none},
				move{2, 3, 2, 4, empty, quiet, none},
				move{2, 3, 2, 5, empty, quiet, none},
				move{2, 3, 2, 6, empty, quiet, none},
				move{2, 3, 1, 2, empty, quiet, none},
				move{2, 3, 0, 1, empty, quiet, none},
				move{2, 3, 3, 2, empty, quiet, none},
				move{2, 3, 4, 1, empty, quiet, none},
				move{2, 3, 5, 0, empty, quiet, none},
				move{2, 3, 1, 4, empty, quiet, none},
				move{2, 3, 0, 5, empty, quiet, none},
				move{2, 3, 3, 4, empty, quiet, none},
				move{2, 3, 4, 5, empty, quiet, none},
				move{2, 3, 5, 6, empty, quiet, none},
				move{2, 3, 6, 7, empty, quiet, none},
			},
		},
		{
			"test rook on row",
			...
			[]move{
				move{6, 3, 5, 3, empty, quiet, none},
				move{6, 3, 7, 3, empty, quiet, none},
			},
		},
		{
			"test bishop on diag",
			...
			[]move{
				move{2, 5, 1, 5, empty, quiet, none},
				move{2, 5, 0, 5, empty, quiet, none},
				move{2, 5, 2, 4, empty, quiet, none},
				move{2, 5, 2, 3, empty, quiet, none},
				move{2, 5, 2, 6, empty, quiet, none},
				move{2, 5, 2, 7, empty, quiet, none},
				move{2, 5, 3, 4, empty, quiet, none},
				move{2, 5, 1, 6, empty, quiet, none},
				move{2, 5, 0, 7, empty, quiet, none},
			},
		},
	}
	for _, tt := range tests {
...
func Test_generateKingMoves(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			[]move{
				move{4, 2, 3, 2, empty, quiet, none},
				move{4, 2, 3, 3, empty, quiet, none},
				move{4, 2, 4, 3, empty, quiet, none},
				move{4, 2, 5, 3, empty, quiet, none},
				move{4, 2, 5, 2, empty, quiet, none},
				move{4, 2, 5, 1, empty, quiet, none},
				move{4, 2, 4, 1, empty, quiet, none},
				move{4, 2, 3, 1, empty, quiet, none},
			},
		},
		{
			"test bishop on diag",
		...
		},
		{
			...
			[]move{
				move{4, 0, 3, 0, empty, quiet, none},
				move{4, 0, 3, 1, empty, quiet, none},
				move{4, 0, 4, 1, empty, quiet, none},
				move{4, 0, 5, 1, empty, quiet, none},
				move{4, 0, 5, 0, empty, quiet, none},
				move{4, 0, 6, 0, empty, kingCastle, none},
				move{4, 0, 2, 0, empty, queenCastle, none},
			},
		},
		{
			"test black castle",
			...
			[]move{
				...
				move{4, 7, 2, 7, empty, queenCastle, none},
			},
		},
		{
		...
		},
		{
			...
			[]move{
				move{3, 7, 2, 7, empty, quiet, none},
				move{3, 7, 4, 7, empty, quiet, none},
				move{3, 7, 4, 6, empty, quiet, none},
				move{3, 7, 3, 6, empty, quiet, none},
...
func Test_generateAllLegalMovesInCheck(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			[]move{
				move{4, 2, 3, 2, empty, quiet, none},
				move{4, 2, 3, 3, blackBishop, quiet, none},
				move{4, 2, 4, 3, empty, quiet, none},
				move{4, 2, 5, 3, empty, quiet, none},
				move{4, 2, 5, 2, empty, quiet, none},
				move{4, 2, 4, 1, empty, quiet, none},
		...
		},
		{
			...
			[]move{
				move{1, 1, 2, 3, blackKnight, quiet, none},
				move{2, 1, 2, 3, blackKnight, quiet, none},
				move{4, 2, 3, 2, empty, quiet, none},
				move{4, 2, 3, 3, empty, quiet, none},
				move{4, 2, 4, 3, empty, quiet, none},
				move{4, 2, 5, 3, empty, quiet, none},
